    ...
    <div className="blade" ref={bladeRef}>
      <div className="blade-header">
        ...
        <img
          src={Header2}
          alt=""
          className="blade-header-img2"
          style={{ width: "158px", height: "27px" }}
        />
      </div>
      ...
      <div className="blade-mission">
        We Push The Boundaries Of Gaming With New Norms To Craft Engaging
        Gameplay. Retain Player’s Sovereignty Over Their Gaming Experience
        Through Blockchain Tech.
      </div>
      <div className="blade-title1">BLADE GAME</div>
      <div className="blade-title2">COLLECTION</div>
      <div className="blade-game1">
        ...
        <div className="blade-game1-content">
          <div className="blade-game1-content-container">
            ...
            <div className="blade-game1-content-title">LOOT ROYALE</div>
          </div>
          <div className="blade-game1-content-desc">
            Loot Royale is a <span>fast-paced battle Royale</span> game with
            heavy loot NFT references. Users can summon game characters using
            their loot NFTs through on-chain ML and decentralized storage.
          </div>
        </div>
      </div>
      <div className="blade-game1" style={{ top: "1527px", left: "40px" }}>
        ...
        <div className="blade-game1-content">
          <div className="blade-game1-content-container">
            <img src={GameLine} className="blade-game1-content-line" />
            <div className="blade-game1-content-title">DUNE FACTORY</div>
          </div>
          <div className="blade-game1-content-desc" style={{ width: "338px" }}>
            DF is a <span>factory + tower defense</span> game with a social
            twist. Build your factories on an alient planet, automate
            production, research about advanced resources and work with (or mess
            around) your friends to build your autonomous world. These virtual
            AW can be built from scratch and represent the core of the game.
          </div>
        </div>
      </div>
      ...
      <div className="blade-subtitle">THe latest from blade</div>
      <div className="blade-plist">
        {posts.map((item, index) => (
          <a
            href={item.link}
            target="_blank"
            className={`blade-plist-item ${
              index % 2 === 0 ? "card1" : "card2"
            }`}
            key={item?.digest}
          >
            <img
              src={index % 2 === 0 ? Plist1 : Plist4}
              alt=""
              className="blade-plist-item-img1"
            />
            <img
              src={index % 2 === 0 ? Plist3 : Plist6}
              alt=""
              className="blade-plist-item-img3"
            />
            <div className="plist-item-content">
              <div className="blade-plist-item-title">{item.wnft.name}</div>
              <img
                src={index % 2 === 0 ? Plist2 : Plist5}
                alt=""
                className="blade-plist-item-img2"
              />
            </div>
          </a>
        ))}
      ...
      <div
        className="blade-subtitle"
        style={{ top: "2648px", left: "78px", width: "300px" }}
      >
        MEET THE BLADE TEAM
      </div>
      <div className="blade-team">
        <div className="blade-team-item" style={{ marginLeft: "36px" }}>
          ...
          <div className="blade-team-item-title">Brawler</div>
        ...
        <div className="blade-team-item">
          ...
          <div className="blade-team-item-title">Zee</div>
          <div className="blade-team-item-desc">
        ...
        <div className="blade-team-item">
          ...
          <div className="blade-team-item-title">0xHastume</div>
          <div className="blade-team-item-desc">
        ...
        <div className="blade-team-item">
          ...
          <div className="blade-team-item-title">K</div>
          <div className="blade-team-item-desc">
      ...
      <div className="blade-footer">
        ...
        <div className="blade-footer-links">
          <a
            className="blade-footer-links-item"
            target="_blank"
