...
function App() {
  ...
  const getData = async () => {
    ...
    await arweave.transactions
      .getData("iuzAI0eNIrzWnvqcWdzeA8eM1J38omD5xujo4zMPl6w", {
        decode: true,
        string: true,
      })
      .then((data) => {
        ...
        postArr.push({
          ...JSON.parse(data),
          link: "https://mirror.xyz/0x43fC86aAaaD9984708348031108b6722F87AC244/F5at4EfBuaJpO0nBhMvpz8G7n9h2sYE73eWX6o38CAc",
        });
        // console.log('data', JSON.parse(data));
      });
    await arweave.transactions
      .getData("LNqkgkVvtWMZYciS96C6vWDGD6TzXXIvENxKJ7ZVu7w", {
        decode: true,
        string: true,
      })
      .then((data) => {
        ...
        postArr.push({
          ...JSON.parse(data),
          link: "https://mirror.xyz/0x43fC86aAaaD9984708348031108b6722F87AC244/7o9zW7-s5GRu5ScDOUlKIRvIG7yKJZYy4ovInXZ8iuA",
        });
        // console.log('data', JSON.parse(data));
      });
    await arweave.transactions
      .getData("JU_RAEidtTbpADeSW2aUShKmpQPoMG_HBNuP842AE_4", {
        decode: true,
        string: true,
      })
      .then((data) => {
        ...
        postArr.push({
          ...JSON.parse(data),
          link: "https://mirror.xyz/0x43fC86aAaaD9984708348031108b6722F87AC244/paRa8fwiLoywyPsNnrD3FeD0Tm4FGYhf5J3YKsZ9u7Q",
        });
        // console.log('data', JSON.parse(data));
      });
    // console.log(postArr);
    ...
    <div className="container" ref={elm}>
      ...
      <div className="header">
        ...
        <div className="link-group">
          ...
          <div className="link" onClick={() => linkToView("mission")}>
            MISSION
          </div>
          <img src={Line} alt="" />
          <div className="link" onClick={() => linkToView("img1")}>
            GAMES
          </div>
          <img src={Line} alt="" />
          <div className="link" onClick={() => linkToView("latest")}>
            BLOG
          </div>
          <img src={Line} alt="" />
          <div
            className="link"
            onClick={() => linkToView("team-title")}
        ...
        >
          We Push The Boundries Of Gaming With New Norms To Craft Engaging
          Gameplay. Retain Player’s Sovereignty Over Their Gaming Experience
        ...
        <motion.div
          ...
          transition={{ delay: 0.3 }}
        >
          a fully on-chain gaming studio dedicated to blurring the lines between
          digital realities and real world.
        </motion.div>
        <div className="collection">
          <div className="game1">
              ...
              <Dialog.Portal>
                ...
                >
                  ...
                  <div className="textbox">
                    ...
                    <div className="des">
                      Loot royale is a fast-paced battle royale game with heavy
            ...
            <div className="title2 loot">LOOT ROYALE</div>
            <div className="content" style={{ marginRight: "10px" }}>
              ...
              >
                fast-paced battle royale
              </span>{" "}
              game with heavy loot NFT references. Users can summon game
              characters using their loot NFTs through on-chain ML and
              decentralized storage.
            </div>
          </div>
          <div className="main">
            ...
            <img
              ref={title}
              className={`title1 animate__animated ${
                showTitle ? "animate__slideInLeft" : ""
              }`}
              src={Text1}
            />
            <img
              className={`title2 animate__animated ${
                showTitle ? "animate__slideInRight" : ""
              }`}
              src={Text2}
            />
          </div>
          <div className="game2">
              ...
              <Dialog.Portal>
                ...
                >
                  ...
                  <div className="textbox">
                    <div className="coming">coming soon</div>
                    <div className="des">
                      DF is a factory + tower defense game with a social twist.
                      Build your factories on an alient planet, automate
                      production, research about advanced resources and work
                      with (or mess around) your friends to build your
                      autonomous world. These virtual AW can be built from
                      scratch and represent the core of the game.
                    </div>
                  </div>
                  <Dialog.Close asChild>
                    <img src={close} alt="" className="close" />
            ...
            <div className="title2 dune">Dune Factory</div>
            <div className="content">
              ...
              game with a social twist. Build your factories on an alient
              planet, automate production, research about advanced resources and
              work with (or mess around) your friends to build your autonomous
              world. These virtual AW can be built from scratch and represent
          ...
          <div className="card-list">
            {posts.map((item, index) => (
              <a
                href={item.link}
                target="_blank"
                className={`card ${index % 2 === 0 ? "card1" : "card2"}`}
                style={{ marginLeft: index === 0 ? "220px" : "" }}
                key={item?.digest}
              >
                <div className="title4">{item.wnft.name}</div>
                <img
                  className="line5"
                  src={index % 2 === 0 ? Line5 : Line9}
                  alt=""
                />
                <div className="content1">{item.wnft.description}</div>
                <div>
                  <img
                    src={index % 2 === 0 ? Arrow : Arrow2}
                    alt=""
                    className="arrow"
                  />
                </div>
        ...
        <div className="team">
          ...
          <div className="team-content">
            Blade games is a fully on-chain game studio with a diverse team from
            backgrounds like game economist, defi degen, smart contract dev,
            crypto media and zkp research. The team has a strong belief in
            crafting digital realities and autonomous worlds.
          ...
          <div className="team-list">
            <div className="team-list-item" style={{ marginLeft: "202px" }}>
              ...
              <div className="team-list-item-title">Brawler</div>
              <div className="team-list-item-content">
                Co-founder of blade games, indie game addict, repeat founder,
                advisor to crypto game studios. Previously built a crypto media
                company in 2019-2021 with over 180,000 subscribers.
              </div>
            </div>
            <div className="team-list-item">
              <img src={Avater2} alt="" className="team-list-item-avater" />
              <img src={Rectangle8} alt="" className="team-list-item-img1" />
              <div className="team-list-item-title">Zee</div>
              <div className="team-list-item-content">
                Co-founder of blade games, game economics connoisseur, sometimes
                dev.
              </div>
            </div>
            <div className="team-list-item">
              ...
              <img src={Rectangle8} alt="" className="team-list-item-img1" />
              <div className="team-list-item-title">0xHastume</div>
              <div className="team-list-item-content">
            ...
            <div className="team-list-item">
              ...
              <img src={Rectangle8} alt="" className="team-list-item-img1" />
              <div className="team-list-item-title">K</div>
              <div className="team-list-item-content">
                15+ years experience as producer of major MMORPG games at at a
                leading Gaming Company in Asia. Factory game player.
              </div>
            </div>
          </div>
        ...
        <div className="footer">
          ...
          <div className="footer-links">
            ...
            <a
              className="footer-link"
              target="_blank"
              href="https://discord.com/invite/bladedao"
            >
              DISCORD
            </a>
            <a
          ...
          <div className="footer-main">
            <div className="main-container">
              ...
              <div className="main-sub">
                BladeDAO is a fully onchain game studio dedicated to blurring
                the lines between digital realities and real world.
              </div>
            </div>
            <div className="main-footer">
              ...
              <div className="main-footer-sec">
                <div className="sec-title">GAMES</div>
                <div
                  className="sec-text"
                  onClick={() => {
                    linkToView("loot");
              ...
              <div className="main-footer-sec">
                <div className="sec-title">PARTNERS</div>
                <div
                  className="sec-text"
                  onClick={() => {
                    linkToView("partners");
